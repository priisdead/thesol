  ...
  useEffect(() => {
    ...
    if (canvas) {
      try {
        ...
        // The browser can refuse a WebGL context (GPU limit, or too many
        // contexts created during dev hot-reloads). Fail gracefully so the
        // rest of the page still renders instead of white-screening.
        console.warn("InfiniteMenu: WebGL unavailable, skipping 3D menu.", err);
        sketch = null;
      }
    }
